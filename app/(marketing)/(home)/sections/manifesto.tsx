          ...
          >
            <div className="text-muted-foreground space-y-4 text-xl *:leading-relaxed md:text-2xl">
              ...
              <p>
                ...
                <strong className="text-foreground font-medium">drop-in</strong>{" "}
              ...
              <p>
                ...
                <strong className="text-foreground font-medium">girl</strong>.
...
const CardDecorator = ({ className }: { className?: string }) => (
  <>
    <span
      className={cn(
        "border-primary rounded-tl-xs absolute -left-px -top-px block size-2 border-l border-t",
        className,
      )}
    ></span>
    <span
      className={cn(
        "border-primary rounded-tr-xs absolute -right-px -top-px block size-2 border-r border-t",
        className,
      )}
    ></span>
    <span
      className={cn(
        "border-primary rounded-bl-xs absolute -bottom-px -left-px block size-2 border-b border-l",
        className,
      )}
    ></span>
    <span
      className={cn(
        "border-primary rounded-br-xs absolute -bottom-px -right-px block size-2 border-b border-r",
        className,
      )}
    ></span>
  </>
