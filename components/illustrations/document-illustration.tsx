...
export const DocumentIllustation = () => {
  return (
    <div
      aria-hidden
      className="bg-card ring-foreground/5 w-16 space-y-2 rounded-md p-2 shadow-md shadow-black/5 ring-1 [--color-border:color-mix(in_oklab,var(--color-foreground)15%,transparent)]"
    >
