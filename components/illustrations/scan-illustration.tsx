...
export const CardDecorator = ({ className }: { className?: string }) => (
  <>
    <span
      className={cn(
        "absolute -left-px -top-px block size-2.5 rounded-tl border-l-[1.5px] border-t-[1.5px] border-white",
        className,
      )}
    ></span>
    <span
      className={cn(
        "absolute -right-px -top-px block size-2.5 rounded-tr border-r-[1.5px] border-t-[1.5px] border-white",
        className,
      )}
    ></span>
    <span
    ...
    <span
      className={cn(
        "absolute -bottom-px -right-px block size-2.5 rounded-br border-b-[1.5px] border-r-[1.5px] border-white",
        className,
      )}
    ></span>
  </>
