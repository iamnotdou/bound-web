      ...
      <div className="col-span-full">
        <div data-grid-content className="py-20">
          ...
          >
            ...
            <span className="in-data-[current=ai]:text-indigo-500 transition-colors duration-200">
              Generative AI Companies,
            </span>{" "}
            <span className="in-data-[current=hosting]:text-indigo-500 transition-colors duration-200">
              Hosting Providers,
            </span>{" "}
            <span className="in-data-[current=payments]:text-indigo-500 transition-colors duration-200">
              Payments Providers,
            </span>{" "}
            <span className="in-data-[current=streaming]:text-indigo-500 transition-colors duration-200">
              Streaming Providers
            </span>
          </p>
        </div>
